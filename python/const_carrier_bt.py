...
def cc_hop(power=nrf24l01.POWER_3, dwell_ms=1):
    counter = 0
...
def cc_hop_timed(power=nrf24l01.POWER_3, dwell_ms=0, time_on_ms=1000, time_off_ms=1000):
    counter = 0
    ...
    while True:
        ...
        while timeout < time_on_ms:
            ...
            timeout = utime.ticks_diff(now, start)
